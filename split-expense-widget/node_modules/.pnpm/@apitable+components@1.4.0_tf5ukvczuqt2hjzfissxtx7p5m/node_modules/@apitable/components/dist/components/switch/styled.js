...
export const SwitchBase = styled.button.attrs(applyDefaultTheme) `
  position: relative;
...
`;
export const SwitchInnerBase = styled.span `
  color:#fff;
  font-size: 12px;
  position: absolute;
  left: 24px;
  ...
  `}
`;
export const SwitchBeforeBase = styled.span.attrs(applyDefaultTheme) `
  display: inline-block;
  position: absolute;
  content: " ";
