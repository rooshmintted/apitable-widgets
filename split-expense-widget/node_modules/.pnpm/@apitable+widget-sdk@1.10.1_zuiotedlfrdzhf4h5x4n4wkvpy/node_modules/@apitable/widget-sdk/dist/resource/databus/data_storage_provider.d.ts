...
export declare class ClientDataStorageProvider extends ClientDataLoader implements databus.IDataStorageProvider {
    private readonly operationExecuted;
    constructor(options: IDataStorageProvider);
    saveOps(ops: IResourceOpsCollect[]): Promise<any> | any;
    nestRoomChangeFromRust(_roomId: string, _data: any): Promise<void>;
}
//# sourceMappingURL=data_storage_provider.d.ts.map