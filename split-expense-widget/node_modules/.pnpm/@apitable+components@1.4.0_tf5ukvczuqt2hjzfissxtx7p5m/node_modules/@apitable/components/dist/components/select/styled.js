...
`;
export const StyledSelectTrigger = styled.div.attrs(applyDefaultTheme) `
  cursor: pointer;
  border-radius: 4px;
...
export const PrefixIcon = styled.span `
  ...
  padding-right: 4px;
`;
export const StyledArrowIcon = styled(PrefixIcon) `
  position: absolute;
  right: 8px;
  display: flex;
  align-items: center;
...
export const hightLightCls = styled.div.attrs(applyDefaultTheme) `
  ...
  padding: 0;
`;
export const StyledListContainer = styled.div.attrs(applyDefaultTheme) `
