...
var APITable = /** @class */ (function () {
    function APITable(config) {
        ...
        this.axios = axios_1.default.create({
            ...
            headers: {
                common: __assign(__assign({}, (this.config.disableClientUserAgent ? {} :
                    (utils_1.isBrowser ? { 'X-APITable-User-Agent': 'APITableJSSDK' } : { 'User-Agent': 'APITableJSSDK' }))), { Authorization: 'Bearer ' + config.token })
            },
    ...
    APITable.prototype.request = function (config) {
        var _a;
     ...
     * @returns
     */
    APITable.prototype.datasheet = function (datasheetId) {
        if (!datasheetId) {
    ...
    Object.defineProperty(APITable.prototype, "nodes", {
        /**
         * Node Management.
         */
        get: function () {
    ...
    Object.defineProperty(APITable.prototype, "spaces", {
        /**
         * Space
         */
        get: function () {
     ...
     * Get a single space.
     */
    APITable.prototype.space = function (spaceId) {
        return new space_1.SpaceManager(this, spaceId);
    };
    APITable.QPSMap = new Map();
    return APITable;
}());
