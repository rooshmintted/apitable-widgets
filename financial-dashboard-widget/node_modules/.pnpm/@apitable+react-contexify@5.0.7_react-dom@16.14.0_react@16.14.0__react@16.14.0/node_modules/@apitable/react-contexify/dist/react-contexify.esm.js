import React, { useContext, createContext, useRef, useEffect, useState, Children, isValidElement, cloneElement, useReducer } from 'react';
import cx from 'clsx';
  ...
  return {
    ...
    emit: function emit(event, args) {
      if (process.env.NODE !== 'production') {
        var currentEv = event;
        if (!eventList.has(event) && currentEv !== 0 /* HIDE_ALL */) {
  ...
  return {
    show: function show(event, params) {
      if (process.env.NODE_ENV === 'development') {
        if (!(props != null && props.id) && !(params != null && params.id)) console.error("You need to provide an id when initializing the hook `useContextMenu({ id: 'your id' })` or when you display the menu `show(e, { id: 'your id' })`. The later is used to override the one defined during initialization.");
      }
      contextMenu.show({
...
function createMenuController() {
  ...
  function openSubmenu() {
    if (isFocused() && isSubmenuFocused()) {
      ...
      currentNode.classList.add("react-contexify__submenu--is-open" /* submenuOpen */);
  ...
  function closeSubmenu() {
    if (isFocused() && !isAtRoot) {
      ...
      parentNode.classList.remove("react-contexify__submenu--is-open" /* submenuOpen */);
      currentItems = items;
...
var _excluded = ["children", "className", "style", "triggerEvent", "data", "propsFromTrigger", "onClick", "disabled", "hidden"];
var Item = function Item(_ref) {
  ...
  var cssClasses = cx("react-contexify__item" /* item */, className, (_cx = {}, _cx["react-contexify__item--disabled" /* itemDisabled */] = isDisabled, _cx));
  return React.createElement("div", Object.assign({}, rest, {
    ...
    className: "react-contexify__item__content" /* itemContent */
  }, children));
};

var _excluded$1 = ["arrow", "children", "disabled", "hidden", "label", "className", "triggerEvent", "propsFromTrigger", "style"];
var Submenu = function Submenu(_ref) {
  ...
  return React.createElement(RefTrackerProvider, {
    ...
    className: "react-contexify__submenu-arrow" /* submenuArrow */
  }, arrow)), React.createElement("div", {
    className: "react-contexify react-contexify__submenu" /* submenu */,
    ref: nodeRef,
    style: submenuStyle
  }, cloneItems(children, {
...
function cloneItems(children, props) {
  ...
  Children.toArray(children).filter(function (child) {
    ...
    if (child.type !== Item && child.type !== Submenu && child.props.children) {
...
var _excluded$2 = ["id", "theme", "style", "className", "children", "animation", "onHidden", "onShown"];
...
var Menu = function Menu(_ref) {
  ...
  useEffect(function () {
    if (state.visible) {
      ...
      if (_y + menuHeight > windowHeight) {
        _y -= _y + menuHeight - windowHeight + 50;
      }
      setState({
        x: _x,
        y: _y
  ...
  function computeAnimationClasses() {
    ...
    if (isStr(animation)) {
      var _cx;
      return cx((_cx = {}, _cx["react-contexify__will-enter--" /* animationWillEnter */ + animation] = animation && visible && !willLeave, _cx["react-contexify__will-leave--" /* animationWillLeave */ + animation + " " + "react-contexify__will-leave--" /* animationWillLeave */ + "'disabled'"] = animation && visible && willLeave, _cx));
    } else if ('enter' in animation && 'exit' in animation) {
      var _cx2;
      return cx((_cx2 = {}, _cx2["react-contexify__will-enter--" /* animationWillEnter */ + animation.enter] = animation.enter && visible && !willLeave, _cx2["react-contexify__will-leave--" /* animationWillLeave */ + animation.exit + " " + "react-contexify__will-leave--" /* animationWillLeave */ + "'disabled'"] = animation.exit && visible && willLeave, _cx2));
    }
    return null;
  }
  ...
  var cssClasses = cx("react-contexify" /* menu */, className, (_cx3 = {}, _cx3["react-contexify__theme--" /* theme */ + theme] = theme, _cx3), computeAnimationClasses());
...
function Separator() {
  return React.createElement("div", {
    className: "react-contexify__separator" /* separator */
  });
}
