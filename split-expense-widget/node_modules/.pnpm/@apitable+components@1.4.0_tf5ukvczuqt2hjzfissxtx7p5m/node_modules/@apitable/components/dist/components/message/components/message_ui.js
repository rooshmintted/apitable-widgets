...
`;
const MessageWrapper = styled.div.attrs(applyDefaultTheme) `
...
`;
export const MessageUI = ({ content, type, onDestroy, motionClassName, duration = 3, icon, }) => {
    ...
    const Icon = React.useMemo(() => {
        ...
        return React.createElement(TypeIcon, { size: 24, color: ['#fff', FourStatusColorMap[type]] });
    }, [type, icon]);
    ...
    return (React.createElement(MessageWrapper, { motionClassName: motionClassName },
        React.createElement(ContentWrapper, { type: type },
            React.createElement(IconWrapper, null, Icon),
            React.createElement(TextWrapper, null, content))));
};
