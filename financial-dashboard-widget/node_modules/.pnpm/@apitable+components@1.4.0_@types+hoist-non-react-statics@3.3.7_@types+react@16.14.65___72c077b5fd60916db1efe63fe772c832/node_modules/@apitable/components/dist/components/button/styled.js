...
const getColors = (color) => (btnTypeOrColor) => {
    const { deepPurple, bgDangerDefault, bgDangerHover, bgDangerActive, bgWarnDefault, bgWarnHover, bgWarnActive, bgSuccessDefault, bgSuccessHover, bgSuccessActive, textCommonPrimary, bgControlsDefault, bgControlsHover, bgControlsActive, bgBrandLightHover, bgBrandLightActive, textStaticPrimary, textBrandDefault, bgBrandLightDefault, bgDangerLightDefault, bgDangerLightHover, bgDangerLightActive, textDangerDefault, bgWarnLightDefault, bgWarnLightHover, bgWarnLightActive, textWarnDefault, bgSuccessLightDefault, bgSuccessLightHover, bgSuccessLightActive, textSuccessDefault, bgBrandDefault, bgBrandHover, bgBrandActive } = color;
...
export const TextSpanStyled = styled.span `
  ...
  line-height:100%;
`;
export const ButtonBase = styled.button.attrs(applyDefaultTheme) `
  cursor: pointer;
